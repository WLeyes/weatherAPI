class UI {
  ...
  paint(weather) {
    this.location.textContent = weather.display_location.full; // From Observation_location
    this.desc.textContent = weather.weather;
    this.string.textContent = weather.temperature_string;
    this.icon.setAttribute('src', weather.icon_url.replace("http://", "https://"));
    ...
    this.time.textContent = `${weather.local_time_rfc822}`;
  }
}
